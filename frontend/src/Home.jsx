...
export default function Home() {
    ...
    return (
        ...
        <div>
            ...
            <h1 class=" z-10 mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">RunwayRevive</h1>
        </div>
            ...
            <figure class="p-10 max-w-screen-md mx-auto text-center">
                ...
                posts.map(post => (
                    ...
                    <article className="w-auto p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="#" className="inline-flex items-center font-medium text-red-600 dark:text-red-500 hover:underline">
                                Read more
