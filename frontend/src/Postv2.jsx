                    ...
                    <form onSubmit={postBlog} >
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="w-full">
                                ...
                                <input value={post.description} onChange={detectChange} type="number" name="description" id="description" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Optional" />
                            </div>
                            <div className="sm:col-span-2">
                        ...
                        <button type="submit" className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-red-700 rounded-lg focus:ring-4 focus:ring-red-200 dark:focus:ring-red-900 hover:bg-red-800">
                            Post
                        </button>
                    </form>
                </div>
